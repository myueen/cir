...
% % tail genes are not informative
% plot(1:1:1000,-col_var_sorted(1:1000),'LineWidth',4)

% foreground label: cell types
Y = cell_type;
Y = categorical(Y);
Y = renamecats(Y,{'B cell';'CD4 T cell';'CD8 T cell';'NK cell';'Plasma cell';'cDC';'cMono';'ncMono';'pDC'},{'1','2','3','4','5','6','7','8','9'});
...
markers = {'o','square','pentagram','o','square','pentagram','o','square','pentagram'};
...
[~, objh] = legend({'B';'CD4 T';'CD8 T';'NK';'Plasma';'cDC';'cMono';'ncMono';'pDC'}, 'location', 'West', 'Fontsize', 14);
...
% end
% hold off
% title('Supervised UMAP','FontSize', 16)
% set(gca, 'FontSize', 16)
